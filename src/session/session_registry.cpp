...
std::vector<Session> discoverSessions() {
  ...
  scanDir("/usr/share/wayland-sessions", SessionType::Wayland, sessions);
  scanDir("/usr/local/share/wayland-sessions", SessionType::Wayland, sessions);
  scanDir("/usr/share/xsessions", SessionType::X11, sessions);
  scanDir("/usr/local/share/xsessions", SessionType::X11, sessions);
